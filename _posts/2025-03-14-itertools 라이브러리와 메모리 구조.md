...
(엄밀히 말하면 C에선 딕셔너리 자료형 자체가 없기 때문에 malloc을 활용해서 동적 객체를 생성 후 이를 딕셔너리처럼 활용해야한다. [구현 방법](https://stackoverflow.com/questions/4384359/quick-way-to-implement-dictionary-in-c))
